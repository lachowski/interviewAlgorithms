 ...
 * 2. Create LinkedList class. It should have only one property named 'head'. New LinkedList is being created with with empty head.
 * 3. Design LinkedList method 'insertFirst(data)'. Look out for situation when there already is node inside linked list.
